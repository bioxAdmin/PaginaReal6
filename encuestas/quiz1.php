...
<head>
    ...
    <link rel="stylesheet" href="../encuestas/estilo.css">
...
<body>
    ...
    <a href="../inicio/index.php"><button class="btn-inicio" width="20%" height="20%">VOLVER A LA PANTALLA PRINCIPAL</button></a>
